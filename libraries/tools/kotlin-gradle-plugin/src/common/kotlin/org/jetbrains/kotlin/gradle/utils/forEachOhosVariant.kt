 ...
 */
internal fun Project.forAllOhosVariants(
    @Suppress("TYPEALIAS_EXPANSION_DEPRECATION") action: (DeprecatedOhosBaseVariant) -> Unit,
) {
    val androidExtension = this.extensions.getByName("ohos")
 ...
 */
internal fun Project.configureOhosVariants(action: (Component) -> Unit) {

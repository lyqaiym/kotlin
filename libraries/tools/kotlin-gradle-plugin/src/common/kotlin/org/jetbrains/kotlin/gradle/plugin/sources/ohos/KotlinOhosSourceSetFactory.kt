...
internal class KotlinOhosSourceSetFactory(
    private val target: KotlinOhosTarget,
    private val kotlin: KotlinProjectExtension,
    private val layout: KotlinOhosSourceSetLayout,
    ...
    fun getOrCreateConfiguredKotlinSourceSet(
        ...
        if (configuredKotlinSourceSets.add(kotlinSourceSet)) {
            ...
            target.project.runProjectConfigurationHealthCheck {
                val layout = this@KotlinOhosSourceSetFactory.layout
    ...
    private fun getOrCreateKotlinSourceSet(
        ...
        return kotlin.sourceSets.getOrCreate(name) { kotlinSourceSet ->
            ...
            kotlinSourceSet.androidSourceSetInfo = KotlinAndroidSourceSetInfo.Mutable(
                ...
                androidVariantType = AndroidBaseSourceSetName.Companion.byName(androidSourceSet.name)?.variantType ?: AndroidVariantType.Unknown
            )
    ...
    private companion object {
        val logger: Logger = Logging.getLogger(KotlinOhosSourceSetFactory::class.java)
    }
}

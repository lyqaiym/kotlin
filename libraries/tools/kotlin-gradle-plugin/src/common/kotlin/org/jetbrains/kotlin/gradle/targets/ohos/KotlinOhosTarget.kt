...
internal fun ObjectFactory.KotlinOhosTarget(
    project: Project,
    targetName: String = "",
    isMultiplatformProject: Boolean = false,
): KotlinOhosTarget = newInstance(targetName, project, isMultiplatformProject)

abstract class KotlinOhosTarget @Inject constructor(
    ...
    private fun checkPublishLibraryVariantsExist() {
        fun OhosProjectHandler.getLibraryVariantNames() =
        ...
        val variantNames = KotlinOhosPlugin.androidTargetHandler().getLibraryVariantNames()
    ...
    override val kotlinComponents by lazy {
        ...
        KotlinOhosPlugin.androidTargetHandler().doCreateComponents()
    }
    ...
    private fun OhosProjectHandler.doCreateComponents(): Set<KotlinTargetComponent> {
        ...
        return publishableVariantGroups.map { (flavorGroupNameParts, androidVariants) ->
            ...
            if (publishLibraryVariantsGroupedByFlavor) {
                JointOhosKotlinTargetComponent(
                    target = this@KotlinOhosTarget,
    ...
    private fun OhosProjectHandler.createAndroidUsageContexts(
        @Suppress("TYPEALIAS_EXPANSION_DEPRECATION") variant: DeprecatedAndroidBaseVariant,
    ...
    private fun createSourcesElementsIfNeeded(
        ...
        return project.configurations.createConsumable(sourcesElementsConfigurationName) {
            ...
            configureSourcesPublicationAttributes(this@KotlinOhosTarget)
        }.get()
    }

...
internal object KotlinOhosSourceSets {

    private val logger = Logging.getLogger(this::class.java)

    fun applyKotlinOhosSourceSetLayout(
        target: KotlinOhosTarget,
        layout: KotlinOhosSourceSetLayout = target.project.kotlinOhosSourceSetLayout
    ) {
        ...
        val factory = KotlinOhosSourceSetFactory(target, project.kotlinExtension, layout, diagnosticsCollector)
        ...
        android.sourceSets.all { androidSourceSet ->
            val kotlinSourceSetName = layout.naming.kotlinSourceSetName(
                ...
                OhosBaseSourceSetName.Companion.byName(androidSourceSet.name)?.variantType
            ) ?: return@all

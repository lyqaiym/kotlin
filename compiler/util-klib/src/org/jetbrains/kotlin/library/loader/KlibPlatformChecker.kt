...
import org.jetbrains.kotlin.library.BaseKotlinLibraryNew
...
interface KlibPlatformChecker {
    fun check(library: BaseKotlinLibraryNew): PlatformCheckMismatch?
    ...
    class Native(private val target: String? = null) : KlibPlatformChecker {
        override fun check(library: BaseKotlinLibraryNew): PlatformCheckMismatch? {

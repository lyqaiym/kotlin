...
internal class KlibIrComponentImpl(
    ...
    private val irFiles: IrArrayReaderNew by lazy {
        IrArrayReader(layoutReader, KlibIrComponentLayout::irFilesFile)
    }

    private val irFileEntries: IrMultiArrayReaderNew? by lazy {
    ...
    private val bodies: IrMultiArrayReaderNew by lazy {
        IrMultiArrayReader(layoutReader, KlibIrComponentLayout::bodiesFile)
    }

    private val types: IrMultiArrayReaderNew by lazy {
        IrMultiArrayReader(layoutReader, KlibIrComponentLayout::typesFile)
    }

    private val signatures: IrMultiArrayReaderNew by lazy {
        IrMultiArrayReader(layoutReader, KlibIrComponentLayout::signaturesFile)
    }

    private val signatureDebugInfos: IrMultiArrayReaderNew? by lazy {
    ...
    private val stringLiterals: IrMultiArrayReaderNew by lazy {
    ...
    override fun declaration(index: Int, fileIndex: Int) = combinedDeclarations.tableItemBytes(fileIndex, DeclarationIdNew(index))

...
//    source_info/core_symbolication/cpp/SourceInfo.cpp:122:66: error: missing field 'fileName'
//    initializer [-Werror,-Wmissing-designated-field-initializers]
//    122 |   __block SymbolSourceInfoLimits limits = {.start = -1, .end = -1};

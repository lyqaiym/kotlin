...
enum class LanguageFeature(
    ...
    DefaultImportOfPackageKotlinComparisons(KOTLIN_1_1, NO_ISSUE_SPECIFIED),
    // 1.2
    ...
    InferenceCompatibility(KOTLIN_1_5, NO_ISSUE_SPECIFIED),
    ...
    TypeInferenceOnCallsWithSelfTypes(KOTLIN_1_6, NO_ISSUE_SPECIFIED),
    ...
    ConsiderExtensionReceiverFromConstrainsInLambda(KOTLIN_1_7, NO_ISSUE_SPECIFIED), // KT-49832
    ...
    SkipStandaloneScriptsInSourceRoots(KOTLIN_1_9, "KT-52525"), // KT-52525
    ...
    PreferDependentTypeVariablesWithProperArgumentConstraint(KOTLIN_2_2, "KT-71854"), // KT-71854
    ...
    ForbidUsingSupertypesWithInaccessibleContentInTypeArguments(sinceVersion = null, "KT-66691, KT-66742"), // KT-66691, KT-66742
    ...
    ValueClasses(sinceVersion = null,""),
    ...
    JavaTypeParameterDefaultRepresentationWithDNN(sinceVersion = null, "KT-59138"), // KT-59138
    // 2.5
    ...
    DontMakeExplicitJavaTypeArgumentsFlexible(sinceVersion = KOTLIN_2_3, "KT-71718"), // KT-71718
    ...
    ContextSensitiveEnumResolutionInWhen(sinceVersion = null, "KT-52774"), // KT-52774
    ...
    IrInlinerBeforeKlibSerialization(sinceVersion = null, "KT-69765"), // KT-69765
